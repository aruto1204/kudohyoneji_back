...
function ae(i, e) {
  ...
  Object.keys(e)
    ...
    .forEach((s) => {
      typeof i[s] > "u" ? (i[s] = e[s]) : oe(e[s]) && oe(i[s]) && Object.keys(e[s]).length > 0 && ae(i[s], e[s]);
    });
}
const he = {
  body: {},
  ...
  for (let t = 1; t < arguments.length; t += 1) {
    ...
    if (s != null && !Ie(s)) {
      ...
      for (let r = 0, o = n.length; r < o; r += 1) {
        ...
        d !== void 0 && d.enumerable && (q(i[a]) && q(s[a]) ? (s[a].__swiper__ ? (i[a] = s[a]) : V(i[a], s[a])) : !q(i[a]) && q(s[a]) ? ((i[a] = {}), s[a].__swiper__ ? (i[a] = s[a]) : V(i[a], s[a])) : (i[a] = s[a]));
      }
    }
  }
  return i;
...
function ve(i) {
  ...
  const l = t > r ? "next" : "prev",
    c = (p, m) => (l === "next" && p >= m) || (l === "prev" && p <= m),
    f = () => {
      (a = new Date().getTime()), o === null && (o = a);
      const p = Math.max(Math.min((a - o) / d, 1), 0),
...
function Oe(i, e) {
  const t = D();
  let s = e.contains(i);
  return !s && t.HTMLSlotElement && e instanceof HTMLSlotElement && ((s = [...e.assignedElements()].includes(i)), s || (s = Le(i, e))), s;
}
function K(i) {
  try {
    console.warn(i);
...
function De(i) {
  ...
  return !c && u && t.touch && h.indexOf(`${a}x${d}`) >= 0 && ((c = r.match(/(Version)\/([\d.]+)/)), c || (c = [0, 1, "13_0_0"]), (u = !1)), l && !m && ((o.os = "android"), (o.android = !0)), (c || p || f) && ((o.os = "ios"), (o.ios = !0)), o;
}
function Se(i) {
  return i === void 0 && (i = {}), Z || (Z = De(i)), Z;
}
let ee;
function Ve() {
  const i = D(),
  ...
  const n = /(iPhone|iPod|iPad).*AppleWebKit(?!.*Safari)/i.test(i.navigator.userAgent),
    r = s(),
    o = r || (n && e.ios);
  return { isSafari: t || r, needPerspectiveFix: t, need3dFix: o, isWebView: n };
}
function Te() {
  return ee || (ee = Ve()), ee;
}
function Be(i) {
        ...
        ((r = new ResizeObserver((f) => {
          o = n.requestAnimationFrame(() => {
            ...
            let u = p,
              h = m;
            f.forEach((T) => {
              let { contentBoxSize: g, contentRect: v, target: w } = T;
              (w && w !== e.el) || ((u = v ? v.width : (g[0] || g).inlineSize), (h = v ? v.height : (g[0] || g).blockSize));
            }),
              (u !== p || h !== m) && a();
          });
        })),
  ...
  t("init", () => {
    ...
    t("destroy", () => {
      l(), n.removeEventListener("resize", a), n.removeEventListener("orientationchange", c);
    });
}
function Fe(i) {
  ...
  const r = [],
    ...
    a = function (c, f) {
      ...
      m.observe(c, { attributes: typeof f.attributes > "u" ? !0 : f.attributes, childList: e.isElement || (typeof f.childList > "u" ? !0 : f).childList, characterData: typeof f.characterData > "u" ? !0 : f.characterData }), r.push(m);
    },
    d = () => {
  ...
  t({ observer: !1, observeParents: !1, observeSlideChildren: !1 }), s("init", d), s("destroy", l);
}
var Ne = {
  on(i, e, t) {
    const s = this;
  ...
  emit() {
    ...
    return (
      typeof r[0] == "string" || Array.isArray(r[0]) ? ((e = r[0]), (t = r.slice(1, r.length)), (s = i)) : ((e = r[0].events), (t = r[0].data), (s = r[0].context || i)),
      t.unshift(s),
...
function _e() {
  ...
  typeof i.params.width < "u" && i.params.width !== null ? (e = i.params.width) : (e = s.clientWidth),
    ...
    !((e === 0 && i.isHorizontal()) || (t === 0 && i.isVertical())) &&
      ((e = e - parseInt($(s, "padding-left") || 0, 10) - parseInt($(s, "padding-right") || 0, 10)), (t = t - parseInt($(s, "padding-top") || 0, 10) - parseInt($(s, "padding-bottom") || 0, 10)), Number.isNaN(e) && (e = 0), Number.isNaN(t) && (t = 0), Object.assign(i, { width: e, height: t, size: i.isHorizontal() ? e : t }));
}
function Re() {
  const i = this;
  function e(S, x) {
  ...
  const t = i.params,
    ...
    c = _(n, `.${i.params.slideClass}, swiper-slide`),
    f = d ? i.virtual.slides.length : c.length;
  let p = [];
  const m = [],
    u = [];
  ...
  for (let S = 0; S < f; S += 1) {
    M = 0;
    let x;
    if ((c[S] && (x = c[S]), I && i.grid.updateSlide(S, x, c), !(c[S] && $(x, "display") === "none"))) {
      if (t.slidesPerView === "auto") {
        O && (c[S].style[i.getDirectionLabel("width")] = "");
        const P = getComputedStyle(x),
          A = x.style.transform,
          F = x.style.webkitTransform;
        if ((A && (x.style.transform = "none"), F && (x.style.webkitTransform = "none"), t.roundLengths)) M = i.isHorizontal() ? de(x, "width") : de(x, "height");
        else {
          const N = e(P, "width"),
            C = e(P, "padding-left"),
            k = e(P, "padding-right"),
          ...
          if (G && G === "border-box") M = N + E + z;
          else {
            const { clientWidth: W, offsetWidth: j } = x;
            M = N + C + k + E + z + (j - W);
          }
        }
        A && (x.style.transform = A), F && (x.style.webkitTransform = F), t.roundLengths && (M = Math.floor(M));
      } else (M = (r - (t.slidesPerView - 1) * w) / t.slidesPerView), t.roundLengths && (M = Math.floor(M)), c[S] && (c[S].style[i.getDirectionLabel("width")] = `${M}px`);
      c[S] && (c[S].swiperSlideSize = M),
        u.push(M),
        t.centeredSlides
          ? ((b = b + M / 2 + y / 2 + w), y === 0 && S !== 0 && (b = b - r / 2 - w), S === 0 && (b = b - r / 2 - w), Math.abs(b) < 1 / 1e3 && (b = 0), t.roundLengths && (b = Math.floor(b)), L % t.slidesPerGroup === 0 && p.push(b), m.push(b))
          : (t.roundLengths && (b = Math.floor(b)), (L - Math.min(i.params.slidesPerGroupSkip, L)) % i.params.slidesPerGroup === 0 && p.push(b), m.push(b), (b = b + M + w)),
        (i.virtualSize += M + w),
        (y = M),
        (L += 1);
    }
  }
  if (((i.virtualSize = Math.max(i.virtualSize, r) + T), o && a && (t.effect === "slide" || t.effect === "coverflow") && (s.style.width = `${i.virtualSize + w}px`), t.setWrapperSize && (s.style[i.getDirectionLabel("width")] = `${i.virtualSize + w}px`), I && i.grid.updateWrapperSize(M, p), !t.centeredSlides)) {
    const S = [];
    for (let x = 0; x < p.length; x += 1) {
      let P = p[x];
      t.roundLengths && (P = Math.floor(P)), p[x] <= i.virtualSize - r && S.push(P);
    }
  ...
  if (d && t.loop) {
    ...
    if (t.slidesPerGroup > 1) {
      ...
      for (let A = 0; A < x; A += 1) p.push(p[p.length - 1] + P);
    }
    for (let x = 0; x < i.virtual.slidesBefore + i.virtual.slidesAfter; x += 1) t.slidesPerGroup === 1 && p.push(p[p.length - 1] + S), m.push(m[m.length - 1] + S), (i.virtualSize += S);
  }
  if ((p.length === 0 && (p = [0]), w !== 0)) {
    const S = i.isHorizontal() && o ? "marginLeft" : i.getDirectionLabel("marginRight");
    c.filter((x, P) => (!t.cssMode || t.loop ? !0 : P !== c.length - 1)).forEach((x) => {
      x.style[S] = `${w}px`;
    });
  }
  ...
  if ((Object.assign(i, { slides: c, snapGrid: p, slidesGrid: m, slidesSizesGrid: u }), t.centeredSlides && t.cssMode && !t.centeredSlidesBounds)) {
    Y(s, "--swiper-centered-offset-before", `${-p[0]}px`), Y(s, "--swiper-centered-offset-after", `${i.size / 2 - u[u.length - 1] / 2}px`);
    const S = -i.snapGrid[0],
      x = -i.slidesGrid[0];
    (i.snapGrid = i.snapGrid.map((P) => P + S)), (i.slidesGrid = i.slidesGrid.map((P) => P + x));
  }
  if ((f !== l && i.emit("slidesLengthChange"), p.length !== g && (i.params.watchOverflow && i.checkOverflow(), i.emit("snapGridLengthChange")), m.length !== v && i.emit("slidesGridLengthChange"), t.watchSlidesProgress && i.updateSlidesOffset(), i.emit("slidesUpdated"), !d && !t.cssMode && (t.effect === "slide" || t.effect === "fade"))) {
    const S = `${t.containerModifierClass}backface-hidden`,
      x = i.el.classList.contains(S);
    f <= t.maxBackfaceHiddenSlides ? x || i.el.classList.add(S) : x && i.el.classList.remove(S);
  }
}
function He(i) {
  const e = this,
...
function We(i) {
  ...
  for (let d = 0; d < s.length; d += 1) {
    ...
    const f = (o + (t.centeredSlides ? e.minTranslate() : 0) - c) / (l.swiperSlideSize + a),
      p = (o - r[0] + (t.centeredSlides ? e.minTranslate() : 0) - c) / (l.swiperSlideSize + a),
      m = -(o - c),
      u = m + e.slidesSizesGrid[d],
      h = m >= 0 && m <= e.size - e.slidesSizesGrid[d],
      T = (m >= 0 && m < e.size - 1) || (u > 1 && u <= e.size) || (m <= 0 && u >= e.size);
    T && (e.visibleSlides.push(l), e.visibleSlidesIndexes.push(d)), ce(l, T, t.slideVisibleClass), ce(l, h, t.slideFullyVisibleClass), (l.progress = n ? -f : f), (l.originalProgress = n ? -p : p);
  }
}
function je(i) {
  const e = this;
  ...
  if (t.loop) {
    const c = e.getSlideIndexByData(0),
      ...
      h = Math.abs(i);
    h >= p ? (a = (h - p) / u) : (a = (h + u - m) / u), a > 1 && (a -= 1);
  }
  Object.assign(e, { progress: n, progressLoop: a, isBeginning: r, isEnd: o }), (t.watchSlidesProgress || (t.centeredSlides && t.autoHeight)) && e.updateSlidesProgress(i), r && !d && e.emit("reachBeginning toEdge"), o && !l && e.emit("reachEnd toEdge"), ((d && !r) || (l && !o)) && e.emit("fromEdge"), e.emit("progress", n);
}
const te = (i, e, t) => {
  e && !i.classList.contains(t) ? i.classList.add(t) : !e && i.classList.contains(t) && i.classList.remove(t);
};
function qe() {
  const i = this,
    ...
    a = (f) => _(s, `.${t.slideClass}${f}, swiper-slide${f}`)[0];
  let d, l, c;
  if (r)
    if (t.loop) {
  ...
  else o ? ((d = e.find((f) => f.column === n)), (c = e.find((f) => f.column === n + 1)), (l = e.find((f) => f.column === n - 1))) : (d = e[n]);
  d && (o || ((c = ze(d, `.${t.slideClass}, swiper-slide`)[0]), t.loop && !c && (c = e[0]), (l = Ae(d, `.${t.slideClass}, swiper-slide`)[0]), t.loop && !l === 0 && (l = e[e.length - 1]))),
    e.forEach((f) => {
      te(f, f === d, t.slideActiveClass), te(f, f === c, t.slideNextClass), te(f, f === l, t.slidePrevClass);
    }),
    i.emitSlidesClasses();
}
const X = (i, e) => {
  ...
  ne = (i) => {
    ...
    else for (let o = Math.max(n - e, 0); o <= Math.min(r + e, t - 1); o += 1) o !== n && (o > r || o < n) && ie(i, o);
  };
function Ye(i) {
...
function Xe(i) {
  ...
  if ((typeof d > "u" && (d = Ye(e)), s.indexOf(t) >= 0)) l = s.indexOf(t);
  else {
    const m = Math.min(n.slidesPerGroupSkip, d);
    l = m + Math.floor((d - m) / n.slidesPerGroup);
  }
  ...
  let p;
  if (e.virtual && n.virtual.enabled && n.loop) p = c(d);
  else if (f) {
    const m = e.slides.find((h) => h.column === d);
    let u = parseInt(m.getAttribute("data-swiper-slide-index"), 10);
    Number.isNaN(u) && (u = Math.max(e.slides.indexOf(m), 0)), (p = Math.floor(u / n.grid.rows));
  } else if (e.slides[d]) {
    const m = e.slides[d].getAttribute("data-swiper-slide-index");
    m ? (p = parseInt(m, 10)) : (p = d);
  } else p = d;
  Object.assign(e, { previousSnapIndex: a, snapIndex: l, previousRealIndex: o, realIndex: p, previousIndex: r, activeIndex: d }), e.initialized && ne(e), e.emit("activeIndexChange"), e.emit("snapIndexChange"), (e.initialized || e.params.runCallbacksOnInit) && (o !== p && e.emit("realIndexChange"), e.emit("slideChange"));
}
function Ue(i, e) {
  const t = this,
    s = t.params;
...
var Ke = { updateSize: _e, updateSlides: Re, updateAutoHeight: He, updateSlidesOffset: $e, updateSlidesProgress: We, updateProgress: je, updateSlidesClasses: qe, updateActiveIndex: Xe, updateClickedSlide: Ue };
function Qe(i) {
...
function Je(i, e) {
  ...
  t.isHorizontal() ? (a = s ? -i : i) : (d = i),
    ...
    n.cssMode ? (r[t.isHorizontal() ? "scrollLeft" : "scrollTop"] = t.isHorizontal() ? -a : -d) : n.virtualTranslate || (t.isHorizontal() ? (a -= t.cssOverflowAdjustment()) : (d -= t.cssOverflowAdjustment()), (r.style.transform = `translate3d(${a}px, ${d}px, ${l}px)`));
  let c;
  const f = t.maxTranslate() - t.minTranslate();
  f === 0 ? (c = 0) : (c = (i - t.minTranslate()) / f), c !== o && t.updateProgress(i), t.emit("setTranslate", t.translate, e);
}
function Ze() {
...
function tt(i, e, t, s, n) {
  ...
  const d = r.minTranslate(),
    l = r.maxTranslate();
  let c;
  if ((s && i > d ? (c = d) : s && i < l ? (c = l) : (c = i), r.updateProgress(c), o.cssMode)) {
    const f = r.isHorizontal();
    if (e === 0) a[f ? "scrollLeft" : "scrollTop"] = -c;
    else {
      if (!r.support.smoothScroll) return ve({ swiper: r, targetPosition: -c, side: f ? "left" : "top" }), !0;
  ...
  return (
    e === 0
      ? (r.setTransition(0), r.setTranslate(c), t && (r.emit("beforeTransitionStart", e, n), r.emit("transitionEnd")))
      : (r.setTransition(e),
        r.setTranslate(c),
...
var it = { getTranslate: Qe, setTranslate: Je, minTranslate: Ze, maxTranslate: et, translateTo: tt };
function st(i, e) {
  const t = this;
...
function rt(i, e) {
  ...
  const t = this,
    { params: s } = t;
  s.cssMode || (s.autoHeight && t.updateAutoHeight(), ye({ swiper: t, runCallbacks: i, direction: e, step: "Start" }));
}
function nt(i, e) {
  i === void 0 && (i = !0);
  const t = this,
    { params: s } = t;
  (t.animating = !1), !s.cssMode && (t.setTransition(0), ye({ swiper: t, runCallbacks: i, direction: e, step: "End" }));
}
var at = { setTransition: st, transitionStart: rt, transitionEnd: nt };
function ot(i, e, t, s, n) {
  i === void 0 && (i = 0), t === void 0 && (t = !0), typeof i == "string" && (i = parseInt(i, 10));
  const r = this;
  let o = i;
  o < 0 && (o = 0);
  const { params: a, snapGrid: d, slidesGrid: l, previousIndex: c, activeIndex: f, rtlTranslate: p, wrapperEl: m, enabled: u } = r;
  if ((!u && !s && !n) || r.destroyed || (r.animating && a.preventInteractionOnTransition)) return !1;
  typeof e > "u" && (e = r.params.speed);
  const h = Math.min(r.params.slidesPerGroupSkip, o);
  let T = h + Math.floor((o - h) / r.params.slidesPerGroup);
  T >= d.length && (T = d.length - 1);
  const g = -d[T];
  if (a.normalizeSlideIndex)
    for (let I = 0; I < l.length; I += 1) {
      const M = -Math.floor(g * 100),
        O = Math.floor(l[I] * 100),
        S = Math.floor(l[I + 1] * 100);
      typeof l[I + 1] < "u" ? (M >= O && M < S - (S - O) / 2 ? (o = I) : M >= O && M < S && (o = I + 1)) : M >= O && (o = I);
    }
  if (r.initialized && o !== f && ((!r.allowSlideNext && (p ? g > r.translate && g > r.minTranslate() : g < r.translate && g < r.minTranslate())) || (!r.allowSlidePrev && g > r.translate && g > r.maxTranslate() && (f || 0) !== o))) return !1;
  o !== (c || 0) && t && r.emit("beforeSlideChangeStart"), r.updateProgress(g);
  let v;
  o > f ? (v = "next") : o < f ? (v = "prev") : (v = "reset");
  const w = r.virtual && r.params.virtual.enabled;
  if (!(w && n) && ((p && -g === r.translate) || (!p && g === r.translate))) return r.updateActiveIndex(o), a.autoHeight && r.updateAutoHeight(), r.updateSlidesClasses(), a.effect !== "slide" && r.setTranslate(g), v !== "reset" && (r.transitionStart(t, v), r.transitionEnd(t, v)), !1;
  if (a.cssMode) {
    const I = r.isHorizontal(),
      M = p ? g : -g;
    if (e === 0)
      w && ((r.wrapperEl.style.scrollSnapType = "none"), (r._immediateVirtual = !0)),
        w && !r._cssModeVirtualInitialSet && r.params.initialSlide > 0
          ? ((r._cssModeVirtualInitialSet = !0),
            requestAnimationFrame(() => {
              m[I ? "scrollLeft" : "scrollTop"] = M;
            }))
          : (m[I ? "scrollLeft" : "scrollTop"] = M),
        w &&
          requestAnimationFrame(() => {
      ...
      if (!r.support.smoothScroll) return ve({ swiper: r, targetPosition: M, side: I ? "left" : "top" }), !0;
      m.scrollTo({ [I ? "left" : "top"]: M, behavior: "smooth" });
    }
    return !0;
  }
  const L = Te().isSafari;
  return (
    w && !n && L && r.isElement && r.virtual.update(!1, !1, o),
    r.setTransition(e),
    r.setTranslate(g),
      ...
      : r.animating ||
        ...
        r.onSlideToWrapperTransitionEnd ||
          (r.onSlideToWrapperTransitionEnd = function (M) {
            !r || r.destroyed || (M.target === this && (r.wrapperEl.removeEventListener("transitionend", r.onSlideToWrapperTransitionEnd), (r.onSlideToWrapperTransitionEnd = null), delete r.onSlideToWrapperTransitionEnd, r.transitionEnd(t, v)));
          }),
  ...
  if (n.params.loop)
    if (n.virtual && n.params.virtual.enabled) o = o + n.virtual.slidesBefore;
      ...
      if (r) {
        ...
        a = n.slides.find((m) => m.getAttribute("data-swiper-slide-index") * 1 === p).column;
      ...
      let f = d - a < c;
      if ((l && (f = f || a < Math.ceil(c / 2)), s && l && n.params.slidesPerView !== "auto" && !r && (f = !1), f)) {
        const p = l ? (a < n.activeIndex ? "prev" : "next") : a - n.activeIndex - 1 < n.params.slidesPerView ? "next" : "prev";
        n.loopFix({ direction: p, slideTo: !0, activeSlideIndex: p === "next" ? a + 1 : a - d + 1, slideRealIndex: p === "next" ? n.realIndex : void 0 });
      }
      if (r) {
        const p = o * n.params.grid.rows;
        o = n.slides.find((m) => m.getAttribute("data-swiper-slide-index") * 1 === p).column;
...
function ct(i, e, t) {
  e === void 0 && (e = !0);
  const s = this,
    { params: n, snapGrid: r, slidesGrid: o, rtlTranslate: a, enabled: d, animating: l } = s;
  ...
  let T = r[u.indexOf(m) - 1];
  if (typeof T > "u" && (n.cssMode || h)) {
    let v;
    r.forEach((w, b) => {
      m >= w && (v = b);
    }),
      typeof v < "u" && (T = h ? r[v] : r[v > 0 ? v - 1 : v]);
  }
  let g = 0;
  if ((typeof T < "u" && ((g = o.indexOf(T)), g < 0 && (g = s.activeIndex - 1), n.slidesPerView === "auto" && n.slidesPerGroup === 1 && n.slidesPerGroupAuto && ((g = g - s.slidesPerViewDynamic("previous", !0) + 1), (g = Math.max(g, 0)))), n.rewind && s.isBeginning)) {
...
function pt() {
  ...
  if (e.loop) {
    ...
    (r = parseInt(i.clickedSlide.getAttribute("data-swiper-slide-index"), 10)),
      e.centeredSlides
        ? i.slideToLoop(r)
        : n > (a ? (i.slides.length - s) / 2 - (i.params.grid.rows - 1) : i.slides.length - s)
        ? (i.loopFix(),
...
var mt = { slideTo: ot, slideToLoop: lt, slideNext: dt, slidePrev: ct, slideReset: ut, slideToClosest: ft, slideToClickedSlide: pt };
function ht(i, e) {
  const t = this,
    { params: s, slidesEl: n } = t;
  if (!s.loop || (t.virtual && t.params.virtual.enabled)) return;
  const r = () => {
      _(n, `.${s.slideClass}, swiper-slide`).forEach((m, u) => {
        m.setAttribute("data-swiper-slide-index", u);
      });
    },
    o = () => {
      const p = _(n, `.${s.slideBlankClass}`);
      p.forEach((m) => {
        m.remove();
      }),
  ...
  s.loopAddBlankSlides && (s.slidesPerGroup > 1 || a) && o();
  const d = s.slidesPerGroup * (a ? s.grid.rows : 1),
    l = t.slides.length % d !== 0,
    c = a && t.slides.length % s.grid.rows !== 0,
    f = (p) => {
      for (let m = 0; m < p; m += 1) {
        const u = t.isElement ? Q("swiper-slide", [s.slideBlankClass]) : Q("div", [s.slideClass, s.slideBlankClass]);
        t.slidesEl.append(u);
      }
    };
  if (l) {
    if (s.loopAddBlankSlides) {
      const p = d - (t.slides.length % d);
      f(p), t.recalcSlides(), t.updateSlides();
    } else K("Swiper Loop Warning: The number of slides is not even to slidesPerGroup, loop mode may not function properly. You need to add more slides (or make duplicates, or empty slides)");
    r();
  } else if (c) {
    if (s.loopAddBlankSlides) {
      const p = s.grid.rows - (t.slides.length % s.grid.rows);
      f(p), t.recalcSlides(), t.updateSlides();
    } else K("Swiper Loop Warning: The number of slides is not even to grid.rows, loop mode may not function properly. You need to add more slides (or make duplicates, or empty slides)");
    r();
  } else r();
  t.loopFix({ slideRealIndex: i, direction: s.centeredSlides ? void 0 : "next", initial: e });
}
function gt(i) {
  let { slideRealIndex: e, slideTo: t = !0, direction: s, setTranslate: n, activeSlideIndex: r, initial: o, byController: a, byMousewheel: d } = i === void 0 ? {} : i;
  const l = this;
  if (!l.params.loop) return;
  l.emit("beforeLoopFix");
  const { slides: c, allowSlidePrev: f, allowSlideNext: p, slidesEl: m, params: u } = l,
    { centeredSlides: h, initialSlide: T } = u;
  if (((l.allowSlidePrev = !0), (l.allowSlideNext = !0), l.virtual && u.virtual.enabled)) {
    t && (!u.centeredSlides && l.snapIndex === 0 ? l.slideTo(l.virtual.slides.length, 0, !1, !0) : u.centeredSlides && l.snapIndex < u.slidesPerView ? l.slideTo(l.virtual.slides.length + l.snapIndex, 0, !1, !0) : l.snapIndex === l.snapGrid.length - 1 && l.slideTo(l.virtual.slidesBefore, 0, !1, !0)),
      (l.allowSlidePrev = f),
      (l.allowSlideNext = p),
      l.emit("loopFix");
    return;
  ...
  g === "auto" ? (g = l.slidesPerViewDynamic()) : ((g = Math.ceil(parseFloat(u.slidesPerView, 10))), h && g % 2 === 0 && (g = g + 1));
  const v = u.slidesPerGroupAuto ? g : u.slidesPerGroup;
  let w = h ? Math.max(v, Math.ceil(g / 2)) : v;
  w % v !== 0 && (w += v - (w % v)), (w += u.loopAdditionalSlides), (l.loopedSlides = w);
  const b = l.grid && u.grid && u.grid.rows > 1;
  c.length < g + w || (l.params.effect === "cards" && c.length < g + w * 2)
    ? K("Swiper Loop Warning: The number of slides is not enough for loop mode, it will be disabled or not function properly. You need to add more slides (or make duplicates) or lower the values of slidesPerView and slidesPerGroup parameters")
    : b && u.grid.fill === "row" && K("Swiper Loop Warning: Loop mode is not compatible with grid.fill = `row`");
  const y = [],
    L = [],
    I = b ? Math.ceil(c.length / u.grid.rows) : c.length,
    M = o && I - T < g && !h;
  let O = M ? T : l.activeIndex;
  typeof r > "u" ? (r = l.getSlideIndex(c.find((C) => C.classList.contains(u.slideActiveClass)))) : (O = r);
  const S = s === "next" || !s,
    x = s === "prev" || !s;
  let P = 0,
    A = 0;
  const N = (b ? c[r].column : r) + (h && typeof n > "u" ? -g / 2 + 0.5 : 0);
  if (N < w) {
    P = Math.max(w - N, v);
    for (let C = 0; C < w - N; C += 1) {
      const k = C - Math.floor(C / I) * I;
      if (b) {
        const E = I - k - 1;
        for (let z = c.length - 1; z >= 0; z -= 1) c[z].column === E && y.push(z);
      } else y.push(I - k - 1);
    }
  } else if (N + g > I - w) {
    (A = Math.max(N - (I - w * 2), v)), M && (A = Math.max(A, g - I + T + 1));
    for (let C = 0; C < A; C += 1) {
      const k = C - Math.floor(C / I) * I;
      b
        ? c.forEach((E, z) => {
  ...
  if (
    ...
    l.params.effect === "cards" && c.length < g + w * 2 && (L.includes(r) && L.splice(L.indexOf(r), 1), y.includes(r) && y.splice(y.indexOf(r), 1)),
    x &&
      y.forEach((C) => {
        (c[C].swiperLoopMoveDOM = !0), m.prepend(c[C]), (c[C].swiperLoopMoveDOM = !1);
      }),
    S &&
      L.forEach((C) => {
        (c[C].swiperLoopMoveDOM = !0), m.append(c[C]), (c[C].swiperLoopMoveDOM = !1);
      }),
    l.recalcSlides(),
    u.slidesPerView === "auto"
      ? l.updateSlides()
      : b &&
        ((y.length > 0 && x) || (L.length > 0 && S)) &&
        l.slides.forEach((C, k) => {
          l.grid.updateSlide(k, C, l.slides);
        }),
    ...
    if (y.length > 0 && x) {
      if (typeof e > "u") {
        const C = l.slidesGrid[O],
          E = l.slidesGrid[O + P] - C;
        d ? l.setTranslate(l.translate - E) : (l.slideTo(O + Math.ceil(P), 0, !1, !0), n && ((l.touchEventsData.startTranslate = l.touchEventsData.startTranslate - E), (l.touchEventsData.currentTranslate = l.touchEventsData.currentTranslate - E)));
      } else if (n) {
        const C = b ? y.length / u.grid.rows : y.length;
        l.slideTo(l.activeIndex + C, 0, !1, !0), (l.touchEventsData.currentTranslate = l.translate);
      }
    } else if (L.length > 0 && S)
      if (typeof e > "u") {
        const C = l.slidesGrid[O],
          E = l.slidesGrid[O - A] - C;
        d ? l.setTranslate(l.translate - E) : (l.slideTo(O - A, 0, !1, !0), n && ((l.touchEventsData.startTranslate = l.touchEventsData.startTranslate - E), (l.touchEventsData.currentTranslate = l.touchEventsData.currentTranslate - E)));
      } else {
        const C = b ? L.length / u.grid.rows : L.length;
        l.slideTo(l.activeIndex - C, 0, !1, !0);
      }
  }
  if (((l.allowSlidePrev = f), (l.allowSlideNext = p), l.controller && l.controller.control && !a)) {
    const C = { slideRealIndex: e, direction: s, setTranslate: n, activeSlideIndex: r, byController: !0 };
    Array.isArray(l.controller.control)
      ? l.controller.control.forEach((k) => {
          !k.destroyed && k.params.loop && k.loopFix({ ...C, slideTo: k.params.slidesPerView === u.slidesPerView ? t : !1 });
        })
      : l.controller.control instanceof l.constructor && l.controller.control.params.loop && l.controller.control.loopFix({ ...C, slideTo: l.controller.control.params.slidesPerView === u.slidesPerView ? t : !1 });
  }
  l.emit("loopFix");
}
function vt() {
...
var yt = { setGrabCursor: St, unsetGrabCursor: Tt };
function bt(i, e) {
  e === void 0 && (e = this);
  function t(s) {
    if (!s || s === R() || s === D()) return null;
...
function xt(i) {
  ...
  let d = s.target;
  if ((r.touchEventsTarget === "wrapper" && !Oe(d, e.wrapperEl)) || ("which" in s && s.which === 3) || ("button" in s && s.button > 0) || (n.isTouched && n.isMoved)) return;
  ...
  if (r.noSwiping && (p ? bt(f, d) : d.closest(f))) {
    e.allowClick = !0;
    return;
  }
  ...
  const m = o.currentX,
    u = o.currentY;
  if (!ue(e, s, m)) return;
  Object.assign(n, { isTouched: !0, isMoved: !1, allowTouchCallbacks: !0, isScrolling: void 0, startMoving: void 0 }), (o.startX = m), (o.startY = u), (n.touchStartTime = U()), (e.allowClick = !0), e.updateSize(), (e.swipeDirection = void 0), r.threshold > 0 && (n.allowThresholdMove = !1);
  let h = !0;
  d.matches(n.focusableElements) && ((h = !1), d.nodeName === "SELECT" && (n.isTouched = !1)), t.activeElement && t.activeElement.matches(n.focusableElements) && t.activeElement !== d && (s.pointerType === "mouse" || (s.pointerType !== "mouse" && !d.matches(n.focusableElements))) && t.activeElement.blur();
  const T = h && e.allowTouchMove && r.touchStartPreventDefault;
  (r.touchStartForcePreventDefault || T) && !d.isContentEditable && s.preventDefault(), r.freeMode && r.freeMode.enabled && e.freeMode && e.animating && !r.cssMode && e.freeMode.onTouchStart(), e.emit("touchStart", s);
}
function Et(i) {
  const e = R(),
    t = this,
  ...
  let l;
  if (d.type === "touchmove") {
    if (((l = [...d.changedTouches].find((y) => y.identifier === s.touchId)), !l || l.identifier !== s.touchId)) return;
  } else l = d;
  if (!s.isTouched) {
  ...
  if (!t.allowTouchMove) {
    d.target.matches(s.focusableElements) || (t.allowClick = !1), s.isTouched && (Object.assign(r, { startX: c, startY: f, currentX: c, currentY: f }), (s.touchStartTime = U()));
    return;
  }
  if (n.touchReleaseOnEdges && !n.loop)
    if (t.isVertical()) {
      ...
      if (o && ((c > r.startX && -t.translate <= t.maxTranslate()) || (c < r.startX && -t.translate >= t.minTranslate()))) return;
      if (!o && ((c < r.startX && t.translate <= t.maxTranslate()) || (c > r.startX && t.translate >= t.minTranslate()))) return;
    }
  ...
  s.allowTouchCallbacks && t.emit("touchMove", d), (r.previousX = r.currentX), (r.previousY = r.currentY), (r.currentX = c), (r.currentY = f);
  const p = r.currentX - r.startX,
    m = r.currentY - r.startY;
  if (t.params.threshold && Math.sqrt(p ** 2 + m ** 2) < t.params.threshold) return;
  if (typeof s.isScrolling > "u") {
    let y;
    (t.isHorizontal() && r.currentY === r.startY) || (t.isVertical() && r.currentX === r.startX) ? (s.isScrolling = !1) : p * p + m * m >= 25 && ((y = (Math.atan2(Math.abs(m), Math.abs(p)) * 180) / Math.PI), (s.isScrolling = t.isHorizontal() ? y > n.touchAngle : 90 - y > n.touchAngle));
  }
  ...
  let u = t.isHorizontal() ? p : m,
    h = t.isHorizontal() ? r.currentX - r.previousX : r.currentY - r.previousY;
  n.oneWayMovement && ((u = Math.abs(u) * (o ? 1 : -1)), (h = Math.abs(h) * (o ? 1 : -1))), (r.diff = u), (u *= n.touchRatio), o && ((u = -u), (h = -h));
  const T = t.touchesDirection;
  (t.swipeDirection = u > 0 ? "prev" : "next"), (t.touchesDirection = h > 0 ? "prev" : "next");
  const g = t.params.loop && !n.cssMode,
    v = (t.touchesDirection === "next" && t.allowSlideNext) || (t.touchesDirection === "prev" && t.allowSlidePrev);
  if (!s.isMoved) {
    if ((g && v && t.loopFix({ direction: t.swipeDirection }), (s.startTranslate = t.getTranslate()), t.setTransition(0), t.animating)) {
      const y = new window.CustomEvent("transitionend", { bubbles: !0, cancelable: !0, detail: { bySwiperTouchMove: !0 } });
  ...
  if ((new Date().getTime(), n._loopSwapReset !== !1 && s.isMoved && s.allowThresholdMove && T !== t.touchesDirection && g && v && Math.abs(u) >= 1)) {
    Object.assign(r, { startX: c, startY: f, currentX: c, currentY: f, startTranslate: s.currentTranslate }), (s.loopSwapReset = !0), (s.startTranslate = s.currentTranslate);
    return;
  }
  t.emit("sliderMove", d), (s.isMoved = !0), (s.currentTranslate = u + s.startTranslate);
  let w = !0,
    b = n.resistanceRatio;
  if (
    ...
    u > 0
      ? (g &&
          ...
          s.currentTranslate > (n.centeredSlides ? t.minTranslate() - t.slidesSizesGrid[t.activeIndex + 1] - (n.slidesPerView !== "auto" && t.slides.length - n.slidesPerView >= 2 ? t.slidesSizesGrid[t.activeIndex + 1] + t.params.spaceBetween : 0) - t.params.spaceBetween : t.minTranslate()) &&
          t.loopFix({ direction: "prev", setTranslate: !0, activeSlideIndex: 0 }),
        s.currentTranslate > t.minTranslate() && ((w = !1), n.resistance && (s.currentTranslate = t.minTranslate() - 1 + (-t.minTranslate() + s.startTranslate + u) ** b)))
      : u < 0 &&
        (g &&
          v &&
          s.allowThresholdMove &&
          s.currentTranslate < (n.centeredSlides ? t.maxTranslate() + t.slidesSizesGrid[t.slidesSizesGrid.length - 1] + t.params.spaceBetween + (n.slidesPerView !== "auto" && t.slides.length - n.slidesPerView >= 2 ? t.slidesSizesGrid[t.slidesSizesGrid.length - 1] + t.params.spaceBetween : 0) : t.maxTranslate()) &&
          t.loopFix({ direction: "next", setTranslate: !0, activeSlideIndex: t.slides.length - (n.slidesPerView === "auto" ? t.slidesPerViewDynamic() : Math.ceil(parseFloat(n.slidesPerView, 10))) }),
        s.currentTranslate < t.maxTranslate() && ((w = !1), n.resistance && (s.currentTranslate = t.maxTranslate() + 1 - (t.maxTranslate() - s.startTranslate - u) ** b))),
...
function Mt(i) {
  ...
  const { params: o, touches: a, rtlTranslate: d, slidesGrid: l, enabled: c } = e;
  ...
  if (e.allowClick) {
    ...
    e.updateClickedSlide((y && y[0]) || s.target, y), e.emit("tap click", s), p < 300 && f - t.lastClickTime < 300 && e.emit("doubleTap doubleClick", s);
  }
  if (
    ((t.lastClickTime = U()),
    ge(() => {
  ...
  (t.isTouched = !1), (t.isMoved = !1), (t.startMoving = !1);
  let m;
  if ((o.followFinger ? (m = d ? e.translate : -e.translate) : (m = -t.currentTranslate), o.cssMode)) return;
  ...
  for (let y = 0; y < l.length; y += y < o.slidesPerGroupSkip ? 1 : o.slidesPerGroup) {
    const L = y < o.slidesPerGroupSkip - 1 ? 1 : o.slidesPerGroup;
    typeof l[y + L] < "u" ? (u || (m >= l[y] && m < l[y + L])) && ((h = y), (T = l[y + L] - l[y])) : (u || m >= l[y]) && ((h = y), (T = l[l.length - 1] - l[l.length - 2]));
  }
  let g = null,
    v = null;
  o.rewind && (e.isBeginning ? (v = o.virtual && o.virtual.enabled && e.virtual ? e.virtual.slides.length - 1 : e.slides.length - 1) : e.isEnd && (g = 0));
  const w = (m - l[h]) / T,
  ...
  if (p > o.longSwipesMs) {
    ...
    e.swipeDirection === "next" && (w >= o.longSwipesRatio ? e.slideTo(o.rewind && e.isEnd ? g : h + b) : e.slideTo(h)), e.swipeDirection === "prev" && (w > 1 - o.longSwipesRatio ? e.slideTo(h + b) : v !== null && w < 0 && Math.abs(w) > o.longSwipesRatio ? e.slideTo(v) : e.slideTo(h));
  } else {
    if (!o.shortSwipes) {
      e.slideTo(e.activeIndex);
      return;
    }
    e.navigation && (s.target === e.navigation.nextEl || s.target === e.navigation.prevEl) ? (s.target === e.navigation.nextEl ? e.slideTo(h + b) : e.slideTo(h)) : (e.swipeDirection === "next" && e.slideTo(g !== null ? g : h + b), e.swipeDirection === "prev" && e.slideTo(v !== null ? v : h));
  }
}
function fe() {
  const i = this,
  ...
  const a = o && e.loop;
  (e.slidesPerView === "auto" || e.slidesPerView > 1) && i.isEnd && !i.isBeginning && !i.params.centeredSlides && !a ? i.slideTo(i.slides.length - 1, 0, !1, !0) : i.params.loop && !o ? i.slideToLoop(i.realIndex, 0, !1, !0) : i.slideTo(i.activeIndex, 0, !1, !0),
    i.autoplay &&
      i.autoplay.running &&
      i.autoplay.paused &&
...
function It(i) {
  const e = this;
  X(e, i.target), !(e.params.cssMode || (e.params.slidesPerView !== "auto" && !e.params.autoHeight)) && e.update();
}
function Lt() {
  const i = this;
...
const be = (i, e) => {
  ...
  !n ||
    ...
    (s.preventClicks || s.preventClicksPropagation) && n[d]("click", i.onClick, !0),
    s.cssMode && r[d]("scroll", i.onScroll),
    s.updateOnWindowResize ? i[l](o.ios || o.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", fe, !0) : i[l]("observerUpdate", fe, !0),
    n[d]("load", i.onLoad, { capture: !0 }));
};
function Ot() {
  const i = this,
    { params: e } = i;
  (i.onTouchStart = xt.bind(i)), (i.onTouchMove = Et.bind(i)), (i.onTouchEnd = Mt.bind(i)), (i.onDocumentTouchStart = Lt.bind(i)), e.cssMode && (i.onScroll = Ct.bind(i)), (i.onClick = Pt.bind(i)), (i.onLoad = It.bind(i)), be(i, "on");
}
function At() {
  be(this, "off");
}
var zt = { attachEvents: Ot, detachEvents: At };
...
function kt() {
  ...
  const o = R(),
    a = s.breakpointsBase === "window" || !s.breakpointsBase ? s.breakpointsBase : "container",
    d = ["window", "container"].includes(s.breakpointsBase) || !s.breakpointsBase ? i.el : o.querySelector(s.breakpointsBase),
    l = i.getBreakpoint(r, a, d);
  if (!l || i.currentBreakpoint === l) return;
  const f = (l in r ? r[l] : void 0) || i.originalParams,
    p = pe(i, s),
    m = pe(i, f),
  ...
  p && !m
    ...
    : !p && m && (n.classList.add(`${s.containerModifierClass}grid`), ((f.grid.fill && f.grid.fill === "column") || (!f.grid.fill && s.grid.fill === "column")) && n.classList.add(`${s.containerModifierClass}grid-column`), i.emitContainerClasses()),
    u && !h ? i.unsetGrabCursor() : !u && h && i.setGrabCursor(),
    ["navigation", "pagination", "scrollbar"].forEach((L) => {
      if (typeof f[L] > "u") return;
      const I = s[L] && s[L].enabled,
        M = f[L] && f[L].enabled;
      I && !M && i[L].disable(), !I && M && i[L].enable();
    });
  const g = f.direction && f.direction !== s.direction,
    v = s.loop && (f.slidesPerView !== s.slidesPerView || g),
    w = s.loop;
  g && t && i.changeDirection(), V(i.params, f);
  ...
  Object.assign(i, { allowTouchMove: i.params.allowTouchMove, allowSlideNext: i.params.allowSlideNext, allowSlidePrev: i.params.allowSlidePrev }),
    T && !b ? i.disable() : !T && b && i.enable(),
    (i.currentBreakpoint = l),
    i.emit("_beforeBreakpoint", f),
    t && (v ? (i.loopDestroy(), i.loopCreate(e), i.updateSlides()) : !w && y ? (i.loopCreate(e), i.updateSlides()) : w && !y && i.loopDestroy()),
    i.emit("breakpoint", f);
}
function Gt(i, e, t) {
...
var Dt = { setBreakpoint: kt, getBreakpoint: Gt };
function Vt(i, e) {
  const t = [];
  return (
    i.forEach((s) => {
...
var Nt = { addClasses: Bt, removeClasses: Ft };
function _t() {
  const i = this,
...
function Ht(i, e) {
  return function (s) {
    ...
    if ((i[n] === !0 && (i[n] = { enabled: !0 }), n === "navigation" && i[n] && i[n].enabled && !i[n].prevEl && !i[n].nextEl && (i[n].auto = !0), ["pagination", "scrollbar"].indexOf(n) >= 0 && i[n] && i[n].enabled && !i[n].el && (i[n].auto = !0), !(n in i && "enabled" in r))) {
      V(e, s);
      return;
    }
    typeof i[n] == "object" && !("enabled" in i[n]) && (i[n].enabled = !0), i[n] || (i[n] = { enabled: !1 }), V(e, s);
  };
}
const se = { eventsEmitter: Ne, update: Ke, translate: it, transition: at, slide: mt, loop: wt, grabCursor: yt, events: zt, breakpoints: Dt, checkOverflow: Rt, classes: Nt },
  re = {};
class B {
  constructor() {
    let e, t;
    ...
    const a = this;
    (a.__swiper__ = !0), (a.support = we()), (a.device = Se({ userAgent: t.userAgent })), (a.browser = Te()), (a.eventsListeners = {}), (a.eventsAnyListeners = []), (a.modules = [...a.__modules__]), t.modules && Array.isArray(t.modules) && a.modules.push(...t.modules);
    const d = {};
    a.modules.forEach((c) => {
      c({ params: t, swiper: a, extendParams: Ht(t, d), on: a.on.bind(a), once: a.once.bind(a), off: a.off.bind(a), emit: a.emit.bind(a) });
    });
    const l = V({}, me, d);
    return (
      (a.params = V({}, l, re, t)),
  ...
  slidesPerViewDynamic(e, t) {
    ...
    const s = this,
      { params: n, slides: r, slidesGrid: o, slidesSizesGrid: a, size: d, activeIndex: l } = s;
    let c = 1;
    if (typeof n.slidesPerView == "number") return n.slidesPerView;
    if (n.centeredSlides) {
      let f = r[l] ? Math.ceil(r[l].swiperSlideSize) : 0,
        p;
      for (let m = l + 1; m < r.length; m += 1) r[m] && !p && ((f += Math.ceil(r[m].swiperSlideSize)), (c += 1), f > d && (p = !0));
      for (let m = l - 1; m >= 0; m -= 1) r[m] && !p && ((f += r[m].swiperSlideSize), (c += 1), f > d && (p = !0));
    } else if (e === "current") for (let f = l + 1; f < r.length; f += 1) (t ? o[f] + a[f] - o[l] < d : o[f] - o[l] < d) && (c += 1);
    else for (let f = l - 1; f >= 0; f -= 1) o[l] - o[f] < d && (c += 1);
    return c;
  }
  update() {
    const e = this;
  ...
  mount(e) {
    ...
    return (
      !o &&
        ...
        s.append(o),
        _(s, `.${t.params.slideClass}`).forEach((a) => {
          o.append(a);
        })),
      Object.assign(t, {
        el: s,
  ...
  destroy(e, t) {
    ...
    return (
      typeof s.params > "u" ||
        ...
        e !== !1 && (s.el && typeof s.el != "string" && (s.el.swiper = null), Me(s)),
        (s.destroyed = !0)),
      null
    );
  }
...
function Wt(i) {
  ...
  function r(u) {
    let h;
    return u && typeof u == "string" && e.isElement && ((h = e.el.querySelector(u) || e.hostEl.querySelector(u)), h)
      ? h
      : (u && (typeof u == "string" && (h = [...document.querySelectorAll(u)]), e.params.uniqueNavElements && typeof u == "string" && h && h.length > 1 && e.el.querySelectorAll(u).length === 1 ? (h = e.el.querySelector(u)) : h && h.length === 1 && (h = h[0])), u && !h ? u : h);
  }
  function o(u, h) {
    const T = e.params.navigation;
    (u = H(u)),
      u.forEach((g) => {
        g && (g.classList[h ? "add" : "remove"](...T.disabledClass.split(" ")), g.tagName === "BUTTON" && (g.disabled = h), e.params.watchOverflow && e.enabled && g.classList[e.isLocked ? "add" : "remove"](T.lockClass));
      });
  }
  function a() {
    ...
    o(h, e.isBeginning && !e.params.rewind), o(u, e.isEnd && !e.params.rewind);
  }
  function d(u) {
  ...
  function c() {
    ...
    if (((e.params.navigation = $t(e, e.originalParams.navigation, e.params.navigation, { nextEl: "swiper-button-next", prevEl: "swiper-button-prev" })), !(u.nextEl || u.prevEl))) return;
    let h = r(u.nextEl),
      T = r(u.prevEl);
    Object.assign(e.navigation, { nextEl: h, prevEl: T }), (h = H(h)), (T = H(T));
    const g = (v, w) => {
      v && v.addEventListener("click", w === "next" ? l : d), !e.enabled && v && v.classList.add(...u.lockClass.split(" "));
    };
    h.forEach((v) => g(v, "next")), T.forEach((v) => g(v, "prev"));
  }
  function f() {
    let { nextEl: u, prevEl: h } = e.navigation;
    (u = H(u)), (h = H(h));
    const T = (g, v) => {
      g.removeEventListener("click", v === "next" ? l : d), g.classList.remove(...e.params.navigation.disabledClass.split(" "));
    };
    u.forEach((g) => T(g, "next")), h.forEach((g) => T(g, "prev"));
  }
  s("init", () => {
    e.params.navigation.enabled === !1 ? m() : (c(), a());
  }),
    ...
    s("enable disable", () => {
      let { nextEl: u, prevEl: h } = e.navigation;
      if (((u = H(u)), (h = H(h)), e.enabled)) {
        a();
        return;
      }
      [...u, ...h].filter((T) => !!T).forEach((T) => T.classList.add(e.params.navigation.lockClass));
    }),
    s("click", (u, h) => {
      let { nextEl: T, prevEl: g } = e.navigation;
      (T = H(T)), (g = H(g));
      const v = h.target;
      let w = g.includes(v) || T.includes(v);
      if (e.isElement && !w) {
        const b = h.path || (h.composedPath && h.composedPath());
        b && (w = b.find((y) => T.includes(y) || g.includes(y)));
      }
      if (e.params.navigation.hideOnClick && !w) {
        ...
        let b;
        T.length ? (b = T[0].classList.contains(e.params.navigation.hiddenClass)) : g.length && (b = g[0].classList.contains(e.params.navigation.hiddenClass)), n(b === !0 ? "navigationShow" : "navigationHide"), [...T, ...g].filter((y) => !!y).forEach((y) => y.classList.toggle(e.params.navigation.hiddenClass));
      }
    });
  const p = () => {
  ...
  Object.assign(e.navigation, { enable: p, disable: m, update: a, init: c, destroy: f });
}
function jt(i) {
  ...
  let o,
    ...
    v;
  function w(E) {
    !e || e.destroyed || !e.wrapperEl || (E.target === e.wrapperEl && (e.wrapperEl.removeEventListener("transitionend", w), !(v || (E.detail && E.detail.bySwiperTouchMove)) && S()));
  }
  const b = () => {
      if (e.destroyed || !e.autoplay.running) return;
      e.autoplay.paused ? (p = !0) : p && ((l = c), (p = !1));
      const E = e.autoplay.paused ? c : f + l - new Date().getTime();
      (e.autoplay.timeLeft = E),
        n("autoplayTimeLeft", E, E / d),
    ...
    y = () => {
      let E;
      return e.virtual && e.params.virtual.enabled ? (E = e.slides.find((G) => G.classList.contains("swiper-slide-active"))) : (E = e.slides[e.activeIndex]), E ? parseInt(E.getAttribute("data-swiper-autoplay"), 10) : void 0;
    },
    L = (E) => {
      if (e.destroyed || !e.autoplay.running) return;
      cancelAnimationFrame(a), b();
      let z = typeof E > "u" ? e.params.autoplay.delay : E;
      (d = e.params.autoplay.delay), (l = e.params.autoplay.delay);
      const G = y();
      !Number.isNaN(G) && G > 0 && typeof E > "u" && ((z = G), (d = G), (l = G)), (c = z);
          ...
          !e ||
            ...
            (e.params.autoplay.reverseDirection
              ? !e.isBeginning || e.params.loop || e.params.rewind
                ? (e.slidePrev(W, !0, !0), n("autoplay"))
                : e.params.autoplay.stopOnLastSlide || (e.slideTo(e.slides.length - 1, W, !0, !0), n("autoplay"))
              : !e.isEnd || e.params.loop || e.params.rewind
              ? (e.slideNext(W, !0, !0), n("autoplay"))
              : e.params.autoplay.stopOnLastSlide || (e.slideTo(0, W, !0, !0), n("autoplay")),
            e.params.cssMode &&
              ((f = new Date().getTime()),
              requestAnimationFrame(() => {
                L();
    ...
    I = () => {
      (f = new Date().getTime()), (e.autoplay.running = !0), L(), n("autoplayStart");
    },
    M = () => {
    ...
    O = (E, z) => {
      if (e.destroyed || !e.autoplay.running) return;
      clearTimeout(o), E || (g = !0);
      const G = () => {
        n("autoplayPause"), e.params.autoplay.waitForTransition ? e.wrapperEl.addEventListener("transitionend", w) : S();
      };
      if (((e.autoplay.paused = !0), z)) {
        T && (c = e.params.autoplay.delay), (T = !1), G();
        return;
      }
      (c = (c || e.params.autoplay.delay) - (new Date().getTime() - f)), !(e.isEnd && c < 0 && !e.params.loop) && (c < 0 && (c = 0), G());
    },
    S = () => {
      (e.isEnd && c < 0 && !e.params.loop) || e.destroyed || !e.autoplay.running || ((f = new Date().getTime()), g ? ((g = !1), L(c)) : L(), (e.autoplay.paused = !1), n("autoplayResume"));
    },
    x = () => {
      if (e.destroyed || !e.autoplay.running) return;
      const E = R();
      E.visibilityState === "hidden" && ((g = !0), O(!0)), E.visibilityState === "visible" && S();
    },
    P = (E) => {
      E.pointerType === "mouse" && ((g = !0), (v = !0), !(e.animating || e.autoplay.paused) && O(!0));
    },
    A = (E) => {
      E.pointerType === "mouse" && ((v = !1), e.autoplay.paused && S());
    },
    F = () => {
      e.params.autoplay.pauseOnMouseEnter && (e.el.addEventListener("pointerenter", P), e.el.addEventListener("pointerleave", A));
    },
    N = () => {
      e.el && typeof e.el != "string" && (e.el.removeEventListener("pointerenter", P), e.el.removeEventListener("pointerleave", A));
    },
    C = () => {
      R().addEventListener("visibilitychange", x);
    },
    k = () => {
      R().removeEventListener("visibilitychange", x);
    };
  s("init", () => {
    e.params.autoplay.enabled && (F(), C(), I());
  }),
    s("destroy", () => {
      N(), k(), e.autoplay.running && M();
    }),
    s("_freeModeStaticRelease", () => {
      (u || g) && S();
    }),
    s("_freeModeNoMomentumRelease", () => {
      e.params.autoplay.disableOnInteraction ? M() : O(!0, !0);
    }),
    s("beforeTransitionStart", (E, z, G) => {
      e.destroyed || !e.autoplay.running || (G || !e.params.autoplay.disableOnInteraction ? O(!0, !0) : M());
    }),
    s("sliderFirstMove", () => {
    ...
    s("touchEnd", () => {
      if (!(e.destroyed || !e.autoplay.running || !m)) {
        ...
        u && e.params.cssMode && S(), (u = !1), (m = !1);
      }
    }),
    s("slideChange", () => {
      e.destroyed || !e.autoplay.running || (T = !0);
    }),
    Object.assign(e.autoplay, { start: I, stop: M, pause: O, resume: S });
}
const qt = { modules: [jt, Wt], loop: !0, slidesPerView: 1, spaceBetween: 0, autoplay: { delay: 3e3, disableOnInteraction: !1 }, speed: 500, navigation: { nextEl: ".swiper-button-next", prevEl: ".swiper-button-prev" }, breakpoints: { 767: { slidesPerView: 2, spaceBetween: 14 }, 1023: { slidesPerView: 3, spaceBetween: 14 } } };
new B(".swiper", qt);
export { qt as swiperConfig };
